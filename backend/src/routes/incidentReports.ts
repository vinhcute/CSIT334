...
export function createIncidentReportsRouter(
  ...
  router.get("/api/incident-reports/me", authMiddleware, controller.myReports);
  router.get("/api/admin/incident-reports", adminOnly, controller.adminIndex);
  router.patch(
    "/api/admin/incident-reports/:id/in-review",
    adminOnly,
    controller.markInReview,
  );
